...
//  SYSCTL_RCGC0_R |= 0x00010000; // 1) activate ADC0 (legacy code)
  ...
  GPIO_PORTE_AMSEL_R |= 0x36;     // 6) enable analog functionality on PE1, PE4, and PE5
...
// ain9 (PE4) 0 to 4095
// ain8 (PE5) 0 to 4095
void ADC_In2981(unsigned long *ain2, unsigned long *ain9, unsigned long *ain8, unsigned long *ain1){
  ...
  *ain1 = ADC0_SSFIFO2_R&0xFFF;    // 3D) read fourth result
